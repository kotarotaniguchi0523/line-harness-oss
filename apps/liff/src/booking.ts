...
function attachEvents(): void {
	...
	// Month navigation
	for (const btn of app.querySelectorAll(".cal-nav")) {
	...
	// Date selection
	for (const el of app.querySelectorAll(".cal-day.active")) {
	...
	// Slot selection
	for (const btn of app.querySelectorAll(".slot-btn.available")) {
		btn.addEventListener("click", () => {
